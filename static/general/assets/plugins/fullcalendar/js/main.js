...
var FullCalendar = (function (exports) {
    ...
    function buildViewSpec(viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
        ...
        return {
            ...
            buttonTextOverride: queryButtonText(dynamicOptionOverrides) ||
                queryButtonText(optionOverrides) || // general-specified buttonText lookup hash takes precedence
    ...
    */
    ...
    // also, whatever is happening in general, have it happen in action queue too
    ...
    var CalendarDataProvider = /** @class */ (function (_super) {
        ...
        function CalendarDataProvider(props) {
            ...
            _this.handleData = function (data) {
                if (!_this.dataManager) { // still within initial run, before assignment in general
